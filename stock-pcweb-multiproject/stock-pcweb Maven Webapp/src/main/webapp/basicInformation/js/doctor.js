...
var User = (function () {
    ...
    function deleteUser() {
        ...
        $('.User_confirmDelete').unbind('click').click(function () {
            ...
            $.ajax({
                url: getContextPath() + 'doctorBaseInfo/delete.do',
                data: {
    ...
    function editUser() {
        ...
        $("#userForm input[name='amender_time']").val(data['amenderTime']);
    ...
    function submitEditUserModal() {
        ...
        if (
            ...
            $.string.isNullOrEmpty($("#userForm input[name='doctor_key']").val()) ||
            $.string.isNullOrEmpty($("#userForm input[name='doctor_name']").val())) {
            callAlert("不能为空！");
            return;
        }
        ...
        $.ajax({
            url: getContextPath() + 'doctorBaseInfo/' + saveType + '.do',
            type: 'POST',
        ...
        user_tb = $("#user_tb").DataTable(
            {
                ...
                columns: [
                    ...
                    { title: "医生工号", data: "doctorKey" },
                    { title: "医生姓名", data: "doctorName" },
                    { title: "医生职称", data: "doctorProf" },
                    { title: "医生职级", data: "doctorLevel" },
                    { title: "处方权", data: "recipePermit" },
                    { title: "按时注册", data: "registerFlag" },
                    { title: "印鉴卡", data: "signatureCard" },
                    { title: "开具抗菌药物权", data: "antibioticsFlag" },
